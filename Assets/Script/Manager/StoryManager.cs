...
public class StoryManager : MonoBehaviour
{
    ...
    void GenerateData()
    {
        ...
        storyData.Add(8, new StoryData(11, "침대에서 찾은 열쇠로 캐비넷을 열었습니다.\n\n캐비넷 안에서 배터리가 없는 손전등와 금고를 발견했습니다."));
        ...
        //Merge
        storyData.Add(11, new StoryData(12, "원형의 금고를 돌려서 금고를 열어 보세요.\n\n초기화를 원할 시에는 화면 아무곳이나 더블클릭하세요."));

        //Tutorial End
        storyData.Add(12, new StoryData(StoryData.StoryType.End, "금고에서 망치를 발견했다.\n\n문을 부시고 탈출에 성공했다"));

        //Stage 1 Start
        storyData.Add(13, new StoryData(StoryData.StoryType.End, "001 문을 열고 나왔다.\n\n정보섬을 나가야 하는데 소리를 질러 봐도 들리지 않는다.\n\n학교 안에는 사람이 없는 것 같다.\n\n학교 밖의 빗소리는 계속 들린다."));
    }

    public StoryData GetStoryData(int storyId)
    {
